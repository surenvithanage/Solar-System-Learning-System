...
public class ProgressService {
    ...
    public Progress update(ProgressDto progressDto) {
        ...
        if (progressOptional.isPresent()) {
            ...
            progress.setQuiz(progressDto.getQuiz());
            progress.setMarks(progressDto.getMarks());
            return progressRepository.save(progress);
        }
        return null;
    ...
    public List<Progress> findByUser(ProgressDto progressDto) {
        return progressRepository.findByUserId(Long.parseLong(progressDto.getUserId()));
    }
