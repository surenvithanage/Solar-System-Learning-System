...
public class SubTopicService {
    ...
    public List<Subtopic> findByTopic(SubTopicDto subTopicDto) {
        Optional<Topic> optional = topicRepository.findById(Long.valueOf(subTopicDto.getTopicId()));
        if (optional.isPresent()) {
            return subTopicRepository.findByTopic(optional.get());
        }
        return null;
    }
}
